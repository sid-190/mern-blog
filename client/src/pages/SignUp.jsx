        ...
        <div className="flex-1">
         ...
         to-pink-500 rounded-lg text-white"
          ...
          <p className="text-sm mt-5">
            ...
            consequatur, perspiciatis, enim, ad doloremque cumque recusandae et
            consequuntur impedit architecto amet sit numquam expedita fugiat?
            Commodi maiores similique culpa.
          </p>
        </div>
        {/* right-side */}
        <div className="flex-1">
